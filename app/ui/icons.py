...
_ICONS = {
    ...
    'bulb_on': '''
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="yellow" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <path d="M9 18h6"></path>
          <path d="M10 22h4"></path>
          <path d="M15.09 14c.18-.98.65-1.74 1.41-2.5A4.65 4.65 0 0018 8 6 6 0 006 8c0 1 .23 2.23 1.5 3.5A4.61 4.61 0 018.91 14"></path>
          <path d="M12 2v2" stroke="yellow"></path>
          <path d="M4 10l2 1" stroke="yellow"></path>
          <path d="M20 10l-2 1" stroke="yellow"></path>
        </svg>
    ''',
    ...
    'color': '''
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <circle cx="13.5" cy="6.5" r="2.5" fill="red" stroke="red"></circle>
          <circle cx="19" cy="13" r="2.5" fill="green" stroke="green"></circle>
          <circle cx="13.5" cy="19.5" r="2.5" fill="blue" stroke="blue"></circle>
          <circle cx="8" cy="13" r="2.5" fill="purple" stroke="purple"></circle>
          <circle cx="13.5" cy="13" r="2.5" fill="white"></circle>
        </svg>
    ''',
...
def get_icon(name, color=None, size=None):
    """
    Get a QIcon object for the given name
    
    Args:
        name: Icon name from the dictionary
        color: Optional color to apply (not used yet)
        size: Optional size for the icon
        
    Returns:
        QIcon: The icon or a default icon if not found
    """
    ...
    # Create icon with renderer
    icon = QIcon()
    
    # Add specific sizes if requested
    if size:
        qsize = QSize(size, size)
        icon.addPixmap(QPixmap(qsize), QIcon.Normal, QIcon.Off)
    else:
        # Add standard sizes
